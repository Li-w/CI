          ...
          <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?=$value['addr']?></td>
                    <td><?=$value['content']?></td>
                    <td><a href="<?=site_url()?>/admin/admin/update/id/<?=$value['id']?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
                    <a href="<?=site_url()?>/admin/admin/delete/id/<?=$value['id']?>" title="Delete" onclick="return confirm('是否删除？')"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
                    </td>
                </tr>
                <?php endforeach?>
            </tbody>
